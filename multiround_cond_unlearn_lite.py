...
def main(args):
    ...
    feat_sampe_time_initial = time.time()
    ...
    feat_sampe_time = feat_sampe_time_end - feat_sampe_time_initial
    print('Feature Sampling Time: ', feat_sampe_time)
    ...
    #------------------------------------------------------------------------
    target_images, target_labels, sub_labels = condensation_sampling(indices_train_wrt_finelabels, train_images, train_labels)
    ...
    cond_end_time = time.time()
    cond_time = cond_end_time - cond_init_time
    ...
    for round_num, (forget_set, retain_set, retain_indices, forget_indices) in enumerate(
        ...
        samp_init_time = time.time()
        # target images are the residual images of clusters that contain forget images
        cond_images, cond_labels, residual_images, residual_labels = seperated_sampling_v2(indices_train_wrt_finelabels, 
                                                                                               train_images, 
                                                                                               train_labels, 
                                                                                               so_far_forget_indices,
                                                                                                sub_labels,
        ...
        samp_time = samp_end_time - samp_init_time

        reduced_retain_images = torch.cat([residual_images, cond_images], dim=0)
        reduced_retain_labels = torch.cat([residual_labels, cond_labels], dim=0)
        ...
        if do_retrain:
            ...
            if round_num == 0:
                unlearning_time+=cond_time+samp_time + feat_sampe_time
            else:
                unlearning_time+=samp_time
            ...
            save_data3(result_directory_path, 'retraining_condlite', df, args.model_name, args.exp, choice, round_num)
        ...
        if do_CF:
            ...
            save_data3(result_directory_path, 'CF_condlite', df, args.model_name, args.exp, choice, round_num)
        ...
        if do_distillation:
            ...
            save_data3(result_directory_path, 'distillation_condlite', df, args.model_name, args.exp, choice, round_num)
        ...
        if do_scrub:
            ...
            save_data3(result_directory_path, 'SCRUB_condlite', df, args.model_name, args.exp, choice, round_num)
        ...
        if do_bad_distillation:
            ...
            save_data3(result_directory_path, 'Bad_distillation_condlite', df, args.model_name, args.exp, choice, round_num)
        ...
        if do_l1_sparsity:
            ...
            save_data3(result_directory_path, 'L1_sparsity_condlite', df, args.model_name, args.exp, choice, round_num)
        ...
        if do_pruning:
            ...
            save_data3(result_directory_path, 'pruning_condlite', df, args.model_name, args.exp, choice, round_num)
